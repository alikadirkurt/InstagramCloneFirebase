...
public class uploadActivity extends AppCompatActivity {
    ...
    public void upload(View view){
        ...
        storageReference.putFile(selectedImage).addOnSuccessListener(this, new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            //dowload Url
                StorageReference newRefence = FirebaseStorage.getInstance().getReference(imageName);
                newRefence.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    @Override
                    public void onSuccess(Uri uri) {
                        String downloadUrl = uri.toString();
                        System.out.println("downloadURL" + downloadUrl);
                        String userEmail = mAuth.getCurrentUser().getEmail();
                        String userCommnet = postCommentText.getText().toString();
                        ...
                        myRef.child("Posts").child(uuidString).child("userComment").setValue(userCommnet);
